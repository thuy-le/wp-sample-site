...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php _e( 'Nothing Found', 'greenr' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		<?php else : ?>
			...
			<p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'greenr' ); ?></p>
			<?php get_search_form(); ?>
